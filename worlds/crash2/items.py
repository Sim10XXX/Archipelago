...
def get_random_filler_item_name(world: Crash2World) -> str:
...
def create_item_with_correct_classification(world: Crash2World, name: str) -> Crash2Item:
    ...
    return Crash2Item(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: Crash2World) -> None:
